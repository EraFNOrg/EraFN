...
{
	return duk_is_object(ctx, idx) && duk_has_prop_string(ctx, idx, "X") &&
		duk_has_prop_string(ctx, idx, "Y") && duk_has_prop_string(ctx, idx, "Z");
}
...
{
	return duk_is_object(ctx, idx) && duk_has_prop_string(ctx, idx, "Pitch") &&
		duk_has_prop_string(ctx, idx, "Yaw") && duk_has_prop_string(ctx, idx, "Roll");
}
